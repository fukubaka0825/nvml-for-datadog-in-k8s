# https://github.com/DataDog/integrations-extras/blob/master/nvml/tests/Dockerfile
# nvml is needed for GPU monitoring https://docs.datadoghq.com/ja/integrations/nvml/
